...
class ObjectDetectionWithMaskPerformer(GeneralTaskPerformer):
    ...
    def __init__(self, params: ObjectDetectionWithMaskParameters, out_channels, num_classes) -> None:
        super().__init__("performer-object_detection")
    ...
    def __init_rpn(self, params):
        ...
        rpn_pre_nms_top_n = dict(
            training=params.rpn_pre_nms_top_n_train, testing=params.rpn_pre_nms_top_n_test
        )
        rpn_post_nms_top_n = dict(
            training=params.rpn_post_nms_top_n_train, testing=params.rpn_post_nms_top_n_test
        )
