...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarize( ap=1, iouThr=None, areaRng='all', maxDets=100):
            ...
            return {"ap": ap, "iouThr": iouThr, "areaRng": areaRng, "maxDets": maxDets, "mean_s": mean_s}
        def _summarizeDets():
            ...
            eval_dicts.append(_summarize(1, iouThr=.5, maxDets=self.params.maxDets[2]))
            eval_dicts.append(_summarize(1, iouThr=.75, maxDets=self.params.maxDets[2]))
            
            eval_dicts.append(_summarize(1, areaRng='small', maxDets=self.params.maxDets[2]))
            eval_dicts.append(_summarize(1, areaRng='medium', maxDets=self.params.maxDets[2]))
            eval_dicts.append(_summarize(1, areaRng='large', maxDets=self.params.maxDets[2]))
