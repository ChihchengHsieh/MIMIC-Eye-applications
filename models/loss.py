...
class CLIPLoss(torch.nn.Module):
  ...
  def forward(self, out0: torch.Tensor, out1: torch.Tensor) -> Tuple:
    ...
    labels = torch.arange(len(out0), device=out0.device) # Q: a list of [0, 1, 2, 3....] as labels? why? A: it's pairwise & symmetric, and only i=j should have the maximum likelihood.
